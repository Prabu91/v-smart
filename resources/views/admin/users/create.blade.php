...
<div class="container mx-auto max-w-lg p-8 bg-white shadow-md rounded-lg">
    <h1 class="text-3xl font-bold text-center mb-6">Tambah Pengguna</h1>
    ...
    <form id="userForm" action="{{ route('admin.users.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="username" id="username" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{ old('username') }}" >

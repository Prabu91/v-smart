...
<div class="container mx-auto p-6">
	<h2 class="text-3xl font-bold mb-6 text-center">Data Pindah Ruangan</h2>
		...
		<form id="transferForm" action="{{ route('transfer-rooms.store') }}" method="POST" class="space-y-6">
			...
			<div class="bg-white p-8 rounded-xl">
				<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
					<div>
						<label for="transfer_room_datetime" class="block text-md font-medium text-txtl">Tanggal dan Waktu Pindah Ruangan</label>
					...
					<div>
						<label for="transfer_room_name" class="block text-md font-medium text-txtl">Nama/Nomor Ruangan</label>
					...
					<div>
						<label for="lab_culture_data" class="block text-md font-medium text-txtl">Hasil Lab Kultur</label>
						<div class="relative">
				...
				<div class="my-4 grid grid-cols-1 md:grid-cols-2 gap-4">
					<div>
						<label for="main_diagnose_transfer" class="block text-lg font-medium text-txtl">Diagnosa Utama</label>
					...
					<div>
						<label for="secondary_diagnose_transfer" class="block text-lg font-medium text-txtl">Diagnosa Sekunder</label>
				...
				<div class="grid grid-cols-1 md:grid-cols-5 gap-4">
					<div>
						<label for="hb_transfer" class="block text-lg font-medium text-txtl">Hb</label>
						<div class="relative">
					...
					<div>
						<label for="leukosit_transfer" class="block text-lg font-medium text-txtl">Leukosit</label>
						<div class="relative">
					...
					<div>
						<label for="pcv_transfer" class="block text-lg font-medium text-txtl">PCV</label>
						<div class="relative">
					...
					<div>
						<label for="trombosit_transfer" class="block text-lg font-medium text-txtl">Trombosit</label>
						<div class="relative">
					...
					<div>
						<label for="kreatinin_transfer" class="block text-lg font-medium text-txtl">Kreatitin</label>
						<div class="relative">
							<input type="number" name="kreatinin_transfer" id="kreatinin_transfer" value="{{ old('kreatinin_transfer') }}" class="text-black font-semibold mt-1 block w-full px-3 py-2 border rounded-md shadow-sm @error('kreatinin_transfer') border-red-500 @else border-gray-300 @enderror" placeholder="1,0">
							<span class="absolute right-3 top-1/2 transform -translate-y-1/2 text-grey-500">mg/dL</span>
						</div>
						<x-input-error :messages="$errors->get('kreatinin_transfer')" class="mt-2" />

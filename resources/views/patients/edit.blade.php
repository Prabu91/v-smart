...
@section('content')
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-grey-900">Edit Data Pasien</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="container mx-auto max-w-lg p-8 bg-white shadow-md rounded-lg">
        <h1 class="text-3xl text-center font-bold">Edit Data Pasien</h1>
        <div class="relative w-full">
            <form id="patientForm" action="{{ route('patients.update', $patient->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('no_jkn', $patient->no_jkn) }}"
                        required>
                    <x-input-error :messages="$errors->get('no_jkn')" />
                </div>

                <div>
                    <label for="no_sep" class="mt-4 block text-md font-medium">
                        Nomor SEP
                    </label>           
                    <input 
                        type="text" 
                        ...
                        value="{{ old('no_sep', $patient->no_sep) }}"
                        >
            ...
            <div id="confirmationModal" class="fixed inset-0 z-50 hidden bg-gray-800 bg-opacity-75 flex items-center justify-center">
                <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full">
                    ...
                    <p>Apakah Anda Yakin Ingin Menyimpan Perubahan Data Pasien?</p>
